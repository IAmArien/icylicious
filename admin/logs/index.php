      ...
      <div class="div-siderbar-menu-links">
        ...
        <button 
          ...
          class="btn btn-outline-success btn-sm
            ...
            btn-menu-unselected"
          type="button">
          <i class="fa-solid fa-cart-shopping"></i><span style="padding-left: 16px">Product Variants</span>
        </button>
        <button 
          id="btn-orders" 
          class="btn btn-outline-success btn-sm
          ...
          <div class="div-content-title">
            <div class="div-content-title-labels">
              ...
              <p class="color-super-light-grey sans-regular" style="font-size: 10pt;">
                Track and Monitor Activity Logs perform per actions.
              </p>
            </div>
            ...
            <table id="data" class="table table-striped" style="width:100%">
              <thead>
                <tr>
                  ...
                  <th class="sans-bold">Activity</th>
                  <th class="sans-bold">Date / Time</th>
                  <th class="sans-bold">User (Fullname)</th>
                  <th class="sans-bold">User (Email)</th>
                </tr>
              </thead>
              <tbody>
                <?php
                  $fetch_query = "SELECT * FROM activity_log ORDER BY id DESC";
