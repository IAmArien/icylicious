  ...
  <body>
    <div class="sidebar-container">
      ...
      <div class="div-sidebar-logo">
        <i class="fa-solid fa-circle-user color-white" style="font-size: 40pt; margin-top: -5px"></i>
        <div>
    ...
    <div class="content">
      <nav class="navbar navbar-expand-lg navbar-light bg-body-tertiary navbar-fixed-top">
        <div class="container-fluid">
          <a class="navbar-brand sans-regular color-white a-navbar-path" href="#" style="cursor: default;">
